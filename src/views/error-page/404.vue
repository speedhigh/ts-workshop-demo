  ...
  >
    <div class="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
      <div class="max-w-md">
        ...
        <p class="text-2xl font-light leading-normal md:text-3xl">很抱歉，我们找不到此页面。 </p>
        <p class="mb-8">但不要担心，您可以在我们的主页上找到许多其他内容。</p>

        <button
          class="bg-primary rounded px-4 py-2 text-sm leading-5 text-white shadow hover:opacity-80"
